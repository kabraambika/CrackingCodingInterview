...
public class Knapsack {
  ...
  /**
   * Top-down approach for knapsack problem using dynamic programming
   * @param capacity knapsack capacity
   * @param weights weights of items in array
   * @param values values of items in array
   * @param n number of items
   * @param dp lookup 2d array n+1 * capacity+1
   * @return returns the maximum value of knapsack
   */
  public static int findKnapsackRec(int capacity, int[] weights, int[] values, int n, int[][] dp){
    ...
    if(weights[n-1] <= capacity){
      dp[n][capacity] = Math.max(values[n-1] + findKnapsackRec(capacity - weights[n-1], weights, values, n-1, dp),
  ...
  /**
   * find maximum value of items can be added in knapsack with capacity c
   * @param capacity knapsack capacity
   * @param weights weights of items in array
   * @param values values of items in array
   * @param n number of items
